...
% fill pattern in the Z direction (vertical printing, lying hexagons)
...
fid = fopen('main_grid_z.mac', 'w');

% INTRODUCTION
fprintf(fid, '\n%s \n%s %d\n', '# Grid Z direction', '# Infill percentage:', infill);
...
fprintf(fid, '\n%s %.2f %s', '/gate/square1/geometry/setZLength', 10-(solid_layers*2), 'cm');
fprintf(fid, '\n/gate/square1/placement/setRotationAxis 0 0 1');
...
fprintf(fid, '\n%s %.2f %s', '/gate/square2/geometry/setZLength', 10-(solid_layers*2), 'cm');
fprintf(fid, '\n/gate/square2/placement/setRotationAxis 0 0 1');
...
fprintf(fid, '\n%s %.0f', '/gate/square1/cubicArray/setRepeatNumberY', repeater_z_2);
fprintf(fid, '\n/gate/square1/cubicArray/setRepeatNumberZ 1');
fprintf(fid, '\n%s %.3f %.3f %s', '/gate/square1/cubicArray/setRepeatVector', diagonal+square_margin, diagonal+square_margin, '0 cm');

% repeaters 2
fprintf(fid, '\n\n# REPEATER 2');
fprintf(fid, '\n/gate/square2/repeaters/insert cubicArray');
fprintf(fid, '\n%s %.0f', '/gate/square2/cubicArray/setRepeatNumberX', repeater_x_2);
fprintf(fid, '\n%s %.0f', '/gate/square2/cubicArray/setRepeatNumberY', repeater_z_1);
fprintf(fid, '\n/gate/square2/cubicArray/setRepeatNumberZ 1');
fprintf(fid, '\n%s %.3f %.3f %s', '/gate/square2/cubicArray/setRepeatVector', diagonal+square_margin, diagonal+square_margin, '0 cm');
...
fprintf(fid, '\n/gate/actor/stat/save output/stats_grid_z_%0.0f.txt', infill);
...
fprintf(fid, '\n/gate/actor/EM-properties/save output/EMprops_grid_z_%0.0f.txt', infill);
...
fprintf(fid, '\n/gate/actor/doseDistribution/save output/output_grid_z_%0.0f.mhd', infill);
